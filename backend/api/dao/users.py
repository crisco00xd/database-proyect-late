...
class Users(db.Model):
    ...
    def getUserSchedule(user):
        sql = text(
            "Select first_name, last_name, unavailabletimestamps.date_reserved, unavailabletimestamps.date_end From users natural inner join unavailabletimestamps Where :td = unavailabletimestamps.user_id")
        try:
